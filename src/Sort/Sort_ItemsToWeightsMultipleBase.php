...
class Sort_ItemsToWeightsMultipleBase extends Sort_MultisortArgsBase {
   ...
   * @return static
   */
  protected function byItemsToWeights(ItemsToWeightsInterface $itemsToWeights, $sortFlags = SORT_REGULAR, $sortDirection = SORT_ASC) {
    $clone = clone $this;
   ...
   * @return mixed[]
   */
  protected function itemsGetMultisortArgs(array $items_unsorted) {
